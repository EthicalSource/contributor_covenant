...
ללא הבדלי גיל, משקל, מגבלות פיזיות, מוצא אתני, הזדהות מגדרית, רמת ניסיון, לאום, 
מראה חיצוני, גזע, דת, זהות ונטיה מינית.

## הסטנדרטים שלנו

דוגמאות של התנהגות התורמת לסביבה חיובית כוללות:

* שימוש בשפה מקבלת ומברכת
* כיבוד של נקודות מבט וחוויות שונות
* קבלה של ביקורת בהבנה
* התמקדות במה שהכי טוב לקהילה
* הפגנת אמפתיה כלפי חברים אחרים מהקהילה

דוגמאות של התנהגות לא מקובלת כוללות:
...
מתאים והוגן בתגובה לכל אירוע של התנהגות בלתי מקובלת.

יש למתחזקי הפרויקט את הזכות והאחריות להסיר, לערך, או לדחות תגובות, קומיטים, קוד, 
עדכוני וויקי, נושאים, או תרומות אחרות שאינם מיושרות עם קוד ההתנהגות הנ״ל, או לחסום
...
תופעות של התנהגות מעליבה, מטרידה, או לא מקובלת יכולות להיות מדווחות על ידי יצירת קשר
עם הקבוצה של הפרויקט ב [הכנס כתבות אימייל]. כלל התלונות יבחנו ויחקרו ויענו על ידי 
...
מתחזקי פרויקט שלא עוקבים ואוכפים את קוד ההתנהגות ברצון טוב עתידים להשלכות זמניות או
קבועות כפי שיקבעו על ידי הנהגת פרויקט זה.
