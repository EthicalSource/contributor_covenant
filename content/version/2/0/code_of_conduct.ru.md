...
видимых или невидимых заболеваний, этнической принадлежности,
...
Мы обязуемся действовать и взаимодействовать таким образом, чтобы вносить вклад в открытое,
...
с Кодексом Поведения, и предоставят причины принятого решения, когда потребуется.

## Область применения

Данный Кодекс Поведения применим во всех общественных местах,
...
электронного адреса, публикации в официальном аккаунте в социальных сетях,
...
было неуместно. Может потребуется принести публичное извинение.

### 2. Предупреждение

**Общественное влияние**: Нарушение в результате одного инцидента или серии действий.

**Consequence**: Предупреждение о последствиях в случае продолжающегося неуместного поведения.
...
в общественных пространствах, а так же во внешних каналах,
...
включая продолжающееся неуместное поведение.
