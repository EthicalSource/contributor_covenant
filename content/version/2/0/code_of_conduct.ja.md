...
虐待的、嫌がらせ、またはその他の許容できない行動の事例は、[INSERT CONTACT METHOD]での執行を担当するコミュニティリーダーに報告される場合があります。
...
**コミュニティへの影響**: コミュニティ内で専門家にふさわしくない、または歓迎されないと思われる不適切な言葉の使用やその他の不適切な行動をすること。
