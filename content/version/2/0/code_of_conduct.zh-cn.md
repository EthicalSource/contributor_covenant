...
社区负责人有权利和义务删除、编辑、拒绝违背本标准的评论（comment）、提交（commit）、代码、维基（wiki）编辑、问题（issue）等贡献。如有必要，需告知采取措施之理由。
...
本行为标准改编自[参与者公约][主页]2.0版，可在此查阅：https://www.contributor-covenant.org/zh-cn/version/2/0/code_of_conduct.html
